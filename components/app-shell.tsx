...
import { Activity, Bell, BookLock, BrainCircuit, BriefcaseBusiness, Calculator, CalendarClock, ChevronDown, CircleHelp, Database, FileInput, FileSpreadsheet, Gauge, LayoutDashboard, MonitorCheck, Newspaper, PanelLeft, Scale, SearchCheck } from "lucide-react";
