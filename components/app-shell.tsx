...
import { Activity, Bell, BookLock, BrainCircuit, BriefcaseBusiness, Calculator, CalendarClock, CalendarDays, ChevronDown, CircleHelp, CircleGauge, ClipboardCheck, Database, FileInput, FileSpreadsheet, Gauge, LayoutDashboard, MonitorCheck, Newspaper, PanelLeft, Scale, SearchCheck } from "lucide-react";
